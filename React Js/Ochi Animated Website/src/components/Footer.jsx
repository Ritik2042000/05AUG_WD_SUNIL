...
const Footer = () => {
    return (
        <div className='w-full h-screen px-20 flex'>
            <div className="w-1/2 font-[FoundersGrotesk] flex flex-col justify-between h-full pb-8">
                <div className="heading">
                    <h1 className='text-[8vw] uppercase -mb-20'>Eye-</h1>
                    <h1 className='text-[8vw] uppercase -mb-20'>Opning</h1>
                </div>
            ...
            <div className="w-1/2 font-[FoundersGrotesk] h-full flex flex-col  ">
                <h1 className='text-[8vw] uppercase'>Presentations</h1>
                <div className="links font-[NeueMontreal] ">
                    <p className='text-[2vw]'>S:</p>
                    {['facebook','instagram','Twitter','Linkedin'].map((data)=>{
                        return <a href="#" className='block w-fit  py-1 text-[1.4vw] capitalize underline hover:no-underline transition-transform '>{data}</a>
                    })}
                </div>
                <div className="links font-[NeueMontreal] mt-3">
                    <p className='text-[2vw]'>S:</p>
                    {['facebook','instagram','Twitter','Linkedin'].map((data)=>{
                       return <a href="#" className='block  py-1 text-[1.4vw] capitalize underline hover:no-underline transition-transform'>{data}</a>
                    })}
                </div>
            </div>
