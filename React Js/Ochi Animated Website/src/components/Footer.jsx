...
const Footer = () => {
    return (
        <div className='w-full h-screen px-20 flex'>
            <div className="w-1/2 font-[FoundersGrotesk] flex flex-col justify-between h-full">
            ...
            <div className="w-1/2 font-[FoundersGrotesk] h-full flex flex-col justify-between ">
                <h1 className='text-[8vw] uppercase'>Presentations</h1>
                <div className="links font-[NeueMontreal]">
                    {['facebook','instagram','Twitter'].map((data)=>{
                       return <a href="#" className='block  py-1 text-[2vw] uppercase'>{data}</a>
                    })}
                </div>
            </div>
