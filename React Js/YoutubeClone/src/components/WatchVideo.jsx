...
const WatchVideo = () => {
    ...
    return (
        <div className="flex  ">
            <div className='w-[60%]'>
                ...
                <div className="flex w-[100%] justify-between">
                    <div className="flex w-[45%] items-center">
                        <div className='channel w-[60%] mt-2 flex '>
                            <img src={''} alt={singleVideoData.data?.items[0]?.snippet?.channelTitle} className='w-[100%]  rounded-full' />
                            <p className='text-sm w-[80%] font-bold '>{singleVideoData.data?.items[0]?.snippet?.channelTitle}</p>
                        </div>
                        <div className='ml-4'>
                    ...
                    <div className="flex w-[45%] justify-between items-center">
                        <div className='cursor-pointer'>
                            <span className='bg-gray-100 px-2 py-2 rounded-l-full  border-r-2 border-solid border-gray-500 hover:bg-gray-200'><AiOutlineLike size={'24px'} className='inline' /> 16</span>
                            <span className='bg-gray-100 px-2 py-2 rounded-r-full hover:bg-gray-200' ><BiDislike className='inline' size={'24px'} /> 16</span>
                        </div>
            ...
            <div className="live-chat w-[40%] ml-28 ">
