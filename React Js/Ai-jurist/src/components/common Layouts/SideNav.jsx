...
const SideNav = () => {
    ...
    return (
        <>
            <Header />
            {isSidebarOpen ? (
                <button id="close-button" className="btn btn-primary" onClick={closeSidebar}>
                    <AiOutlineClose />
                </button>
            ) : (
                <button id="menu-button" className="btn btn-primary" onClick={openSidebar}>
                    <AiOutlineMenu />
                </button>
            )}
            <div className={`nav-wrapper px-3 bg-nav  ${isSidebarOpen ? 'open' : ''}`}>
                ...
                <div className="nav-links py-4 ">
                    <ul>
                        <NavLink className="align-items-center d-flex "
                            to="/dashboard"
                        ...
                        <NavLink className="" to="/tempalte" activeClassname="active">
                            <li>
