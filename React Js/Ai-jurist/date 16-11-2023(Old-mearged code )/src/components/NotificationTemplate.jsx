...
const NotificationTemplate = () => {
  ...
  const columns = [
    ...
    // {
    //   name: "NOTIFICATION SUBJECT (عربي)",
    //   selector: (row) => row.notification_arabic,
    //   sortable: true,
    // },
    {
      name: "STATUS",
    ...
    },
    {
      name: "EDIT",
      cell: (row) => (
        <NavLink to="/notificationtemplate/editnotificationtemplate">
  ...
  const filteredData = data.filter((row) =>
    row.notification.toLowerCase().includes(search.toLowerCase())
  );
      ...
      <div className="main-wrapper">
        <div className="container">
          <div className="page-title">
            <h1 className="page-heading mb-0">Notification Template</h1>
          </div>
