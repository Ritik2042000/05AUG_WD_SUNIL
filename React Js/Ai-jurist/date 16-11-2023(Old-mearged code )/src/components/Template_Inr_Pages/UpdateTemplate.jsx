      ...
      <div className="main-wrapper">
        <div className="container">
          <div className="page-title">
            <h1 className="page-heading mb-0">Update Template</h1>
          </div>
          <div className="card">
                ...
                <div className="row my-2">
                  <div className="col-xxl-8 col-lg-12">
                    <div className="mb-3">
                      <label className="form-label mt-3">
                        <div className="d-flex justify-content-between">
                          <h6 className="required">Template Title (ENGLISH)</h6>
                        </div>
                      </label>
                      <input
                    ...
                    <div className="mb-3 ">
                      <label className="form-label mt-3">
                        <div className="d-flex justify-content-between">
                          <h6 className="required">Template Title (عربي)</h6>
                        </div>
                      </label>
                      <input
                  ...
                  <div className="col-xxl-4 col-lg-12 py-3 mt-4 mt-xxl-0">
                    <div className="template-color-section">
                      <h5>Update Template Color</h5>
                      <Colorpicker />
                    </div>
                  </div>
                </div>

                <div className="row mt-xxl-5 mt-4">
